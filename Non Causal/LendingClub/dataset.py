...
def get_dataset(seed):
    ...
    # y = deepcopy(df['loan_status'].values)
    # del df['loan_status']

    # rus = RandomUnderSampler(random_state=42)
    # X_res, y_res = rus.fit_resample(df.values, y)

    # X, _, y, _, = train_test_split(X_res, y_res, 
    #                                 test_size=0.9, 
    #                                 random_state=seed)
    ...
    # print("Reduced Dataset to:", df.shape)

    # pd.save_csv('data/under_sampled_df.csv', )
